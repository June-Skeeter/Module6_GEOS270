...
<div style="overflow: hidden;
  padding-top: 56.25%;
  position: relative">
  <iframe src="../Python_Notebooks/Van_Trees.html" title="Processes" scrolling="no" frameborder="0"
    style="border: 0;
   height: 100%;
   left: 0;
   position: absolute;
...
<a href="../Python_Notebooks/Van_Trees.html" target="_blank">View Map in New Tab</a>
